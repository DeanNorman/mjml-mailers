...
const press = () => {
   return (
      <Layout>
         <div>
            <h1>22seven in the media.</h1>
         </div>

         <div>
            <div>
               <img src="Quotationmarks-icon.jpg" alt=""/>  
            </div>
               <h1> Press.</h1>
               <p>News, views, debates and discussions. Read, watch or listen to the full stories from here.</p>
         </div>
